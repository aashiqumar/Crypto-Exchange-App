...
const inputBoxDefault = "my-2 w-full rounded-xl h-10 p-3 outline-none bg-transparent text-white border-none text-sm white-glassmorphism";
const inputBoxMessage = "my-2 w-full rounded-xl h-20 p-3 outline-none bg-transparent text-white border-none text-sm white-glassmorphism";
